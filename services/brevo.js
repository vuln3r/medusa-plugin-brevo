  ...
  return _createClass(BrevoService, [{
    ...
    value: function () {
      var _getAbandonedCarts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var _this$options_4,
          ...
          _options$third,
          _this2 = this;
        var options, now, firstCheck, secondCheck, thirdCheck, cartRepository, carts, abandonedCarts, _iterator, _step, _cart$metadata4, cart, orderCheck, cartData, _loop, _i, _abandonedCarts;
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 47:
              _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
                var _cart$region, _cart$region2, _cart$region3, _options$action, _cart$metadata2, _cart$metadata3;
                var cart, check, items, _yield$_this2$extract, locale, countryCode, templateId, action, sendOptions, _cart$metadata;
                  ...
                  while (1) switch (_context6.prev = _context6.next) {
                    ...
                    case 5:
                      ...
                      sendOptions = {
                        ...
                        // Ensure the template ID is a number
                      ...
                      if (!(check < thirdCheck && !(cart !== null && cart !== void 0 && (_cart$metadata = cart.metadata) !== null && _cart$metadata !== void 0 && _cart$metadata.third_abandonedcart_mail))) {
                        _context6.next = 16;
                        break;
                      }
                      _context6.next = 16;
                    ...
                    case 16:
                      ...
                      break;
                    case 18:
                      if (!(check < secondCheck && !(cart !== null && cart !== void 0 && (_cart$metadata2 = cart.metadata) !== null && _cart$metadata2 !== void 0 && _cart$metadata2.second_abandonedcart_mail))) {
                        _context6.next = 23;
                        break;
                      }
                      _context6.next = 21;
                    ...
                    case 21:
                      ...
                      break;
                    case 23:
                      if (cart !== null && cart !== void 0 && (_cart$metadata3 = cart.metadata) !== null && _cart$metadata3 !== void 0 && _cart$metadata3.first_abandonedcart_mail) {
                        _context6.next = 26;
                        break;
                      }
                      _context6.next = 26;
            ...
            case 49:
              ...
              return _context7.delegateYield(_loop(), "t2", 51);
            case 51:
              _i++;
              _context7.next = 49;
              break;
        ...
        }, _callee6, this, [[15, 39, 42, 45], [20, 26]]);
      }));
    ...
    value: function () {
      var _sendNotification = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(event, eventData, attachmentGenerator) {
        ...
        var group, action, event_, data, attachments, templateId, _data$locale, _data$locale2, sendOptions;
          ...
          while (1) switch (_context13.prev = _context13.next) {
            ...
            case 19:
              ...
              if (_typeof(templateId) === "object") {
                ...
                if ((_data$locale = data.locale) !== null && _data$locale !== void 0 && _data$locale.countryCode && templateId[data.locale.countryCode]) {
                  templateId = templateId[data.locale.countryCode];
                } else if ((_data$locale2 = data.locale) !== null && _data$locale2 !== void 0 && _data$locale2.locale && templateId[data.locale.locale]) {
    ...
    value: function () {
      var _orderShipmentCreatedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(_ref6, attachmentGenerator) {
        var id, fulfillment_id, order, shipment, tracking_numbers, locale;
          ...
          while (1) switch (_context16.prev = _context16.next) {
            case 0:
              ...
              return this.orderService_.retrieve(id, {
                select: ["id", "email", "shipping_total", "discount_total", "tax_total", "refunded_total", "gift_card_total", "subtotal", "total", "refundable_amount", "created_at", "updated_at", "customer_id", "currency_code", "tax_rate", "cart_id"],
                relations: ["customer", "billing_address", "shipping_address", "discounts", "discounts.rule", "shipping_methods", "shipping_methods.shipping_option", "payments", "fulfillments", "returns", "gift_cards", "gift_card_transactions", "region", "items", "items.variant", "items.variant.product"]
              });
            case 3:
            ...
            case 6:
              ...
              tracking_numbers = shipment.tracking_links.map(function (link) {
                return link.tracking_number;
              }).join(", ");
              _context16.next = 10;
          ...
          while (1) switch (_context20.prev = _context20.next) {
            case 0:
              ...
              return this.orderService_.retrieve(id, {
                ...
                select: ["id", "status", "fulfillment_status", "payment_status", "display_id", "cart_id", "customer_id", "email", "billing_address_id", "shipping_address_id", "region_id", "currency_code", "tax_rate", "canceled_at", "metadata", "no_notification", "idempotency_key", "draft_order_id", "created_at", "updated_at", "shipping_total", "discount_total", "tax_total", "refunded_total", "gift_card_total", "subtotal", "total", "paid_total", "refundable_amount", "external_id", "sales_channel_id"],
                // Add comprehensive relations including items.variant.product and all nested relationships
                relations: ["customer", "billing_address", "shipping_address", "discounts", "discounts.rule", "shipping_methods", "shipping_methods.shipping_option", "payments", "fulfillments", "returns", "gift_cards", "gift_card_transactions", "items", "items.variant", "items.variant.product", "items.variant.product.profiles", "items.adjustments", "items.tax_lines", "region", "sales_channel", "claims", "swaps"]
              });
            case 3:
              ...
              return Promise.all(order.items.map( /*#__PURE__*/function () {
                var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(originalItem) {
                  var _originalItem$variant, _originalItem$metadat;
                  var totals, processedItem;
                  return _regeneratorRuntime().wrap(function _callee17$(_context19) {
                    while (1) switch (_context19.prev = _context19.next) {
                      case 0:
                        _context19.next = 2;
                        return _this4.totalsService_.getLineItemTotals(originalItem, order, {
                          include_tax: true,
                          use_tax_lines: true
                        });
                      case 2:
                        ...
                        processedItem = _objectSpread(_objectSpread({}, originalItem), {}, {
                          // All original item fields including metadata, adjustments, tax_lines

                          // Preserve complete variant data including metadata and price_attributes
                          variant: originalItem.variant ? _objectSpread(_objectSpread({}, originalItem.variant), {}, {
                            metadata: originalItem.variant.metadata || {},
                            // Preserve any price_attributes from variant metadata
                            price_attributes: ((_originalItem$variant = originalItem.variant.metadata) === null || _originalItem$variant === void 0 ? void 0 : _originalItem$variant.price_attributes) || null,
                            // Include complete product information with descriptions, images, and metadata
                            product: originalItem.variant.product ? _objectSpread(_objectSpread({}, originalItem.variant.product), {}, {
                              metadata: originalItem.variant.product.metadata || {},
                              // Preserve product descriptions, images, and all attributes
                              description: originalItem.variant.product.description,
                              images: originalItem.variant.product.images || [],
                              thumbnail: originalItem.variant.product.thumbnail,
                          ...
                          discounted_price: "".concat(_this4.humanPrice_(totals.total / originalItem.quantity, currencyCode), " ").concat(currencyCode),
                          price: "".concat(_this4.humanPrice_(totals.original_total / originalItem.quantity, currencyCode), " ").concat(currencyCode),
                          // Normalize thumbnail URL while preserving original
                          thumbnail: _this4.normalizeThumbUrl_(originalItem.thumbnail),
                          ...
                          price_attributes: ((_originalItem$metadat = originalItem.metadata) === null || _originalItem$metadat === void 0 ? void 0 : _originalItem$metadat.price_attributes) || null
                        });
                        return _context19.abrupt("return", processedItem);
                      case 5:
                      case "end":
            ...
            case 15:
              ...
              }, 0); //console.log(`TOTAL ${this.humanPrice_(total, currencyCode)} ${currencyCode}`,)
    ...
    key: "humanPrice_",
    value: function humanPrice_(amount, currencyCode) {
      if (!amount) return "0.00";
      var normalizedAmount = (0, _medusaCoreUtils.humanizeAmount)(amount, currencyCode);
    ...
    key: "OLDextractLocale",
    value: function () {
      var _OLDextractLocale = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(fromOrder) {
        var cart;
      ...
      function OLDextractLocale(_x22) {
        return _OLDextractLocale.apply(this, arguments);
      }
      return OLDextractLocale;
    }()
  }, {
    key: "extractLocale",
    value: function () {
      var _extractLocale = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(fromOrder) {
        var cart, _ref11, locale, countryCode;
        return _regeneratorRuntime().wrap(function _callee20$(_context22) {
          while (1) switch (_context22.prev = _context22.next) {
            ...
            case 4:
              cart = _context22.sent;
              // Extract locale and countryCode from cart context
              _ref11 = cart.context || {}, locale = _ref11.locale, countryCode = _ref11.countryCode;
